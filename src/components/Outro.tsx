    ...
    >
      ...
      >
        ...
        <article className="break-keep flex flex-col gap-4 justify-center items-center description">
          ...
          <h3 className="mt-4 flex gap-2 items-center text-base lg:text-lg font-bold text-center whitespace-nowrap">
            <img src={logo} className="size-8 lg:size-12" alt="YOURSSU" />
            YOURSSU
          </h3>
          ...
          <div className="flex items-center gap-4">
            <a href="https://yourssu.com" target="_blank">
              <IcExternalLinkLine className="size-10 text-white/75 hover:scale-105 hover:text-white active:scale-95 transition-all -mx-2" />
            </a>
